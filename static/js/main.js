/**
 * FYHUB FINANCE CLONE - Main JavaScript
 * Dark mode toggle and loading helpers
 */
...
function toggleTheme() {
    ...
    // Save preference
    localStorage.setItem('fyhub-theme', newTheme);
}

// Load saved theme
document.addEventListener('DOMContentLoaded', () => {
    const savedTheme = localStorage.getItem('fyhub-theme');
    if (savedTheme === 'dark') {
